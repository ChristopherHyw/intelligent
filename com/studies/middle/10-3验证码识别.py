...
TFRECORD_FILE = "D:/WorkSpace/data/imageDatas/numberimagemode/train.tfrecords"
...
image_batch,label_batch0,label_batch1,label_batch2,label_batch3 = tf.train.shuffle_batch(
    [image,label0,label1,label2,label3],batch_size=BATCH_SIZE,capacity=25000,min_after_dequeue=5000,num_threads=1)
...
with tf.Session() as sess:
    ...
    total_loss = (loss0+loss0+loss0+loss0)/4.0
    ...
    for i in range(6001):
        ...
        if i % 20 == 0:
            if i % 2000 == 0:
                ...
                if i == 6000:
                    saver.save(sess,"D:/WorkSpace/data/imageDatas/numbermode",global_step=i)
                    break
        coord.request_stop()
        coord.join(threads)
